package com.tolaba.controlador;
...
import com.tolaba.servicio.ContratoServicio;
import com.tolaba.servicio.PersonaServicio;
import com.tolaba.servicio.PropiedadServicio;
...
public class ContratoControlador {
    ...
    public String listar(
        ...
        model.addAttribute("contratos", contratoServicio.listarFiltrados(propiedadId, inquilinoId, estadoContrato, fechaInicio));
    ...
    public String guardar(
        ...
        try {
            ...
            redirectAttributes.addFlashAttribute("mensaje", "Contrato guardado correctamente en el sistema InmoGesta.");
    ...
    public String actualizar(
        ...
        try {
            ...
            redirectAttributes.addFlashAttribute("mensaje", "Contrato actualizado correctamente en InmoGesta.");
            return "redirect:/contratos";
        } catch (IllegalArgumentException e) {
            model.addAttribute("error", e.getMessage());
            cargarDatosFormulario(model);
    ...
    public String eliminar(@PathVariable Long id, RedirectAttributes redirectAttributes) {
        try {
            ...
            redirectAttributes.addFlashAttribute("mensaje", "Contrato dado de baja de forma lógica correctamente.");
        } catch (IllegalArgumentException e) {
